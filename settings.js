...
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=a2gVADQL#JsBNnvYpEtN7tiEquuqk93rGGO0x_GLtpKeTBvxiuVI' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
PORT: process.env.PORT === undefined ? "8000" : process.env.PORT,
SUDO: process.env.SUDO === undefined ? '94716682532' : process.env.SUDO,
...
DELETEMSGSENDTO : process.env.DELETEMSGSENDTO === undefined ? '94716682532' : process.env.DELETEMSGSENDTO,
